# CocoaPods podspec for IGSDKCoreKit
...
Pod::Spec.new do |s|
  ...
  s.source_files   = "IGSDKCoreKit/IGSDKCoreKit/**/*.{h,m}"
  s.public_header_files = "IGSDKCoreKit/IGSDKCoreKit/*.{h}"
  s.header_dir = "IGSDKCoreKit"
end
